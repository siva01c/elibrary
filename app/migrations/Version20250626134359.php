...
final class Version20250626134359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE book (id SERIAL PRIMARY KEY, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, isbn VARCHAR(20) DEFAULT NULL, description TEXT DEFAULT NULL, publication_year INT DEFAULT NULL)
        SQL);
